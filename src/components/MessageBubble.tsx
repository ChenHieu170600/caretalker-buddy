        ...
        <div className="markdown-content">
          <ReactMarkdown 
            ...
            components={{
              ...
              a: ({node, ...props}) => <a className="text-purple-200" {...props} />,
              code: ({node, ...props}) => <code className="bg-purple-700 text-white" {...props} />,
              ...
              blockquote: ({node, ...props}) => <blockquote className="border-purple-400 text-white" {...props} />,
              ...
              pre: ({node, ...props}) => <pre className="bg-purple-700 text-white" {...props} />,
              ...
              hr: ({node, ...props}) => <hr className="border-purple-400" {...props} />
            }}
          >
            {message.content}
          </ReactMarkdown>
