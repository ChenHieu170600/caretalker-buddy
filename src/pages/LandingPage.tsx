      ...
      <nav className="py-4 px-6 md:px-12 w-full z-20 fixed top-0 bg-starry-deeper/80 backdrop-blur-lg border-b border-white/10">
        <div className="container mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className="h-8 w-8 rounded-full bg-gradient-to-r from-purple-600 to-purple-400" />
          ...
          <div className="md:hidden absolute top-16 left-0 right-0 bg-starry-deeper/95 backdrop-blur-lg border-b border-white/10 shadow-lg p-4">
            <div className="flex flex-col space-y-4 px-4">
              ...
              <div className="flex space-x-3 pt-2">
                ...
                <Button size="sm" className="w-1/2 bg-purple-600 hover:bg-purple-500 text-white">
                  Sign up
                </Button>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-1/2 flex justify-center md:justify-end">
                <div className="relative w-full max-w-md">
                  <div className="absolute -top-6 -right-6 w-64 h-64 bg-purple-600 rounded-full opacity-10 blur-3xl animate-pulse-gentle"></div>
                  <div className="absolute -bottom-10 -left-10 w-64 h-64 bg-purple-400 rounded-full opacity-10 blur-3xl animate-pulse-gentle delay-300"></div>
                  <div className="relative z-10 glass-panel p-6 rounded-3xl shadow-lg animate-float">
                    <div className="flex items-start space-x-3 mb-4">
                      ...
                      <div className="bg-purple-600/20 rounded-2xl p-3">
        ...
        <section id="how-it-works" className="py-16 md:py-24">
          <div className="container mx-auto px-6">
            ...
            <div className="relative">
              ...
              <div className="hidden lg:block absolute top-1/2 left-0 right-0 h-0.5 bg-gradient-to-r from-purple-600 to-purple-400 transform -translate-y-1/2 z-0"></div>
              
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
                {steps.map((step, index) => (
                  <div key={index} className="flex flex-col items-center">
                    <div className="w-16 h-16 rounded-full bg-gradient-to-r from-purple-600 to-purple-400 flex items-center justify-center text-white text-2xl font-bold mb-6 shadow-lg">
                      {step.number}
                    </div>
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-6">
            <div className="relative glass-panel rounded-3xl p-8 md:p-12 overflow-hidden">
              {/* Decorative elements */}
              <div className="absolute top-0 right-0 w-64 h-64 bg-purple-400 rounded-full opacity-10 blur-3xl transform translate-x-1/3 -translate-y-1/3"></div>
              <div className="absolute bottom-0 left-0 w-64 h-64 bg-purple-600 rounded-full opacity-10 blur-3xl transform -translate-x-1/3 translate-y-1/3"></div>
              ...
              <div className="relative z-10 max-w-3xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                  <Input 
                    ...
                    className="bg-starry-darker border-purple-600/30 focus-visible:ring-purple-500 text-starry-text"
                  />
                  <Button className="bg-purple-600 hover:bg-purple-500 whitespace-nowrap text-white">
                    Get Started Free
                  </Button>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-1">
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-starry-muted hover:text-purple-500 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-starry-muted hover:text-purple-500 transition-colors">About Us</a></li>
                <li><a href="#" className="text-starry-muted hover:text-purple-500 transition-colors">Careers</a></li>
                <li><a href="#" className="text-starry-muted hover:text-purple-500 transition-colors">Press</a></li>
                <li><a href="#" className="text-starry-muted hover:text-purple-500 transition-colors">Blog</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-starry-muted hover:text-purple-500 transition-colors">Community</a></li>
                <li><a href="#" className="text-starry-muted hover:text-purple-500 transition-colors">Mental Health Tips</a></li>
                <li><a href="#" className="text-starry-muted hover:text-purple-500 transition-colors">Support</a></li>
                <li><a href="#" className="text-starry-muted hover:text-purple-500 transition-colors">Accessibility</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-starry-muted hover:text-purple-500 transition-colors">Privacy Policy</a></li>
                <li><a href="#" className="text-starry-muted hover:text-purple-500 transition-colors">Terms of Service</a></li>
                <li><a href="#" className="text-starry-muted hover:text-purple-500 transition-colors">Cookie Policy</a></li>
                <li><a href="#" className="text-starry-muted hover:text-purple-500 transition-colors">GDPR Compliance</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-white/10">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex items-center space-x-4">
                <a href="#" className="text-xs text-starry-muted hover:text-purple-500 transition-colors">
                  Privacy
                </a>
                <a href="#" className="text-xs text-starry-muted hover:text-purple-500 transition-colors">
                  Terms
